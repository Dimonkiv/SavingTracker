...
fun SelectIconScreen(
    ...
    onIntent: (SelectIconIntent) -> Unit
) {
    Box(
        ...
        Column(
            ...
            SelectIconContent(
                item = state,
                onColorSelected = {
                    onIntent(SelectIconIntent.OnColorSelected(it))
                },
                onIconSelected = {
                    onIntent(SelectIconIntent.OnIconSelected(it))
                }
            )
        }
        ...
        AppButton(
            ...
            onClick = {
                onIntent(SelectIconIntent.OnSelectButtonClick)
            },
            title = "Select"
        )
    }
