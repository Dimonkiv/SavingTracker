...
import com.dimonkiv.savingstracker.feature.transaction.presentation.AddTransactionIntent
...
fun AddTransaction(
    ...
    Column(
        ...
        OutlinedTextField(
            ...
            value = state.balance,
            onValueChange = {
                onIntent(AddTransactionIntent.OnBalanceTextChanged(it))
            },
            label = {
        ...
        OutlinedTextField(
            ...
            value = state.note,
            onValueChange = {
                onIntent(AddTransactionIntent.OnNoteTextChanged(it))
            },
            label = {
